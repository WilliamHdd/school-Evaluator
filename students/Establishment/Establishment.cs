...
namespace Evaluator
{
	/* [Serializable] means that this class objects and instances 
	will be export to a file when export() function is called.
	Same for every classe that has to be saved. See end of this file.*/
	...
	public class Establishment
	{
		...
		/* Imports all the data from a file.
		 This allows to import all the entries at 
		 once istead of having to encode them one by one.*/
